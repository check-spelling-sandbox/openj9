...
<spec xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://www.ibm.com/j9/builder/spec" xsi:schemaLocation="http://www.ibm.com/j9/builder/spec spec-v1.xsd" id="aix_ppc">
	...
	<properties>
		...
		<property name="SE6_package" value="ap32"/>
		<property name="aotTarget" value="ppc-aix"/>
		...
		<property name="graph_label.java60_26" value="pap3260_26"/>
		<property name="graph_label.java6_rebuilt_extension" value="zip"/>
		<property name="graph_label.java7" value="pap3270"/>
		<property name="graph_label.java70_27" value="pap3270_27"/>
		<property name="graph_label.java7_raw" value="jdk7-aix-ppc32"/>
		<property name="graph_label.java8" value="pap3280"/>
		<property name="graph_label.java9" value="pap3290"/>
		...
		<property name="j2seRuntimeDir" value="jre/lib/ppc"/>
		<property name="j2seTags" value="pap3260,j9vmap3224"/>
		...
		<property name="main_shortname" value="ap32"/>
		<property name="os.lineDelimiter" value="unix"/>
		<property name="platform_arch" value="ppc"/>
		<property name="sun.jdk7.platform_id" value="aix-i586"/>
