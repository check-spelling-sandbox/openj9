...
-->
<spec xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://www.ibm.com/j9/builder/spec" xsi:schemaLocation="http://www.ibm.com/j9/builder/spec spec-v1.xsd" id="linux_ppc-64_cmprssptrs">
	<name>Linux PPC 64bit Compressed Pointers</name>
	<asmBuilderName>LinuxPPC64</asmBuilderName>
	...
	<properties>
		...
		<property name="SE6_package" value="xp64"/>
		<property name="aotTarget" value="ppc-linux"/>
		<property name="complianceTestingJavaLibraryPath" value="linux_ppc-64"/>
		...
		<property name="graph_label.java60_26" value="pxp64cmprssptrs60_26"/>
		<property name="graph_label.java6_rebuilt_extension" value="zip"/>
		<property name="graph_label.java7" value="pxp64cmprssptrs70"/>
		<property name="graph_label.java70_27" value="pxp64cmprssptrs70_27"/>
		<property name="graph_label.java8" value="pxp64cmprssptrs80"/>
		<property name="graph_label.java9" value="pxp64cmprssptrs90"/>
		...
		<property name="j2seTags" value="pxp64cmprssptrs60,j9vmxp64cmprssptrs24"/>
		...
		<property name="javatestPlatform" value="linux_ppc-64_cr"/>
		...
		<property name="main_shortname" value="xp64"/>
