...
-->
<spec xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://www.ibm.com/j9/builder/spec" xsi:schemaLocation="http://www.ibm.com/j9/builder/spec spec-v1.xsd" id="linux_ppc-64_le">
	<name>Linux PPC LE 64bit</name>
	...
	<properties>
		...
		<property name="graph_label.java60_26" value="pxp64le60_26"/>
		<property name="graph_label.java6_rebuilt_extension" value="zip"/>
		<property name="graph_label.java7" value="pxp64le70"/>
		<property name="graph_label.java70_27" value="pxp64le70_27"/>
		<property name="graph_label.java8" value="pxp64le80"/>
		<property name="graph_label.java9" value="pxp64le90"/>
		<property name="graph_label.osid" value="lnx"/>
		<property name="graph_label.profile" value="_le"/>
		...
		<property name="j2seTags" value="pxp64le60,j9vmxp64le24"/>
		...
		<property name="javatestPlatform" value="linux_ppc-64_le"/>
