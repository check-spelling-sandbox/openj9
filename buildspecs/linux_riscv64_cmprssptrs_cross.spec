...
-->
<spec xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://www.ibm.com/j9/builder/spec" xsi:schemaLocation="http://www.ibm.com/j9/builder/spec spec-v1.xsd" id="linux_riscv64_cmprssptrs_cross">
	<name>Linux RISC-V 64bit Compressed Pointers</name>
	<asmBuilderName>LinuxRISCV64</asmBuilderName>
	<cpuArchitecture>riscv</cpuArchitecture>
	<os>linux</os>
	<defaultJCL>Sidecar</defaultJCL>
	<defaultSizes>desktop (256M + big OS stack)</defaultSizes>
	<priority>250</priority>
	<owners>
		<owner>jincheng@ca.ibm.com</owner>
	</owners>
	<properties>
		<property name="SE6_extension" value="tar.gz"/>
		<property name="SE6_package" value="rv64"/>
		<property name="aotTarget" value="riscv-linux"/>
		<property name="complianceTestingJavaLibraryPath" value="linux_riscv64"/>
		...
		<property name="graph_enable_compiler_cmd" value="source {$buildinfo.fsroot.unixBin$}/platform/linux_riscv64/set_gcc7_env &amp;&amp;"/>
		<property name="graph_label.classlib" value="150"/>
		<property name="graph_label.java60_26" value="prv64cmprssptrs60_26"/>
		<property name="graph_label.java6_rebuilt_extension" value="zip"/>
		<property name="graph_label.java7" value="prv64cmprssptrs70"/>
		<property name="graph_label.java70_27" value="prv64cmprssptrs70_27"/>
		<property name="graph_label.java8" value="prv64cmprssptrs80"/>
		<property name="graph_label.java9" value="prv64cmprssptrs90"/>
		...
		<property name="graph_req.arch0" value="arch:riscv"/>
		...
		<property name="j2seRuntimeDir" value="jre/lib/riscv64"/>
		<property name="j2seTags" value="prv64cmprssptrs60,j9vmrv64cmprssptrs24"/>
		<property name="j9BuildName" value="linux_riscv64"/>
		...
		<property name="javatestPlatform" value="linux_riscv64_cr"/>
		...
		<property name="main_shortname" value="rv64"/>
		<property name="os.lineDelimiter" value="unix"/>
		<property name="platform_arch" value="riscv64"/>
		...
		<property name="uma_make_cmd_riscv_gcc_cxx" value="gcc"/>
		<property name="uma_make_cmd_ranlib" value="ranlib"/>
		<property name="uma_processor" value="riscv64"/>
	...
	<flags>
		...
		<flag id="module_codegen_common" value="false"/>
		<flag id="module_codegen_riscv" value="false"/>
		<flag id="module_codegen_ilgen" value="false"/>
		<flag id="module_codegen_opt" value="false"/>
		<flag id="module_codert_common" value="false"/>
		<flag id="module_codert_riscv" value="false"/>
		<flag id="module_codert_vm" value="false"/>
		...
		<flag id="module_jit_common" value="false"/>
		<flag id="module_jit_riscv" value="false"/>
		<flag id="module_jit_vm" value="false"/>
		<flag id="module_jitrt_common" value="false"/>
		<flag id="module_jitrt_riscv" value="false"/>
