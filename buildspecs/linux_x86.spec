...
<spec xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://www.ibm.com/j9/builder/spec" xsi:schemaLocation="http://www.ibm.com/j9/builder/spec spec-v1.xsd" id="linux_x86">
	...
	<owners>
		<owner>maciek_klimkowski@ca.ibm.com</owner>
	</owners>
	<properties>
		...
		<property name="graph_label.java6" value="pxi3260"/>
		<property name="graph_label.java60_26" value="pxi3260_26"/>
		<property name="graph_label.java6_rebuilt_extension" value="zip"/>
		<property name="graph_label.java7" value="pxi3270"/>
		<property name="graph_label.java70_27" value="pxa6470_27"/>
		<property name="graph_label.java7_raw" value="jdk7-linux-i586"/>
		<property name="graph_label.java8" value="pxa6480"/>
		<property name="graph_label.java8_raw" value="jdk8-linux-i586"/>
		...
		<property name="graph_property.linux_2.4.graph_req.machine.test" value="{$machine_mapping.386$}"/>
		...
		<property name="j2seTags" value="pxi3260,j9vmxi3224"/>
		<property name="j9BuildName" value="linux_x86"/>
		...
		<property name="javatestPlatform" value="linux_x86-32"/>
		...
		<property name="sun.jdk7.platform_id" value="linux-i586"/>
		<property name="sun.jdk8.platform_id" value="linux-i586"/>
