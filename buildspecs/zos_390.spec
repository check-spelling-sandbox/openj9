...
-->
<spec xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://www.ibm.com/j9/builder/spec" xsi:schemaLocation="http://www.ibm.com/j9/builder/spec spec-v1.xsd" id="zos_390">
	<name>zOS S390</name>
	...
	<owners>
		<owner>grant_goodes@ca.ibm.com</owner>
	</owners>
	<properties>
		<property name="SE6_extension" value="pax.Z"/>
		<property name="SE6_package" value="mz31"/>
		...
		<property name="graph_label.java60_26" value="pmz3160_26"/>
		<property name="graph_label.java6_rebuilt_extension" value="zip"/>
		<property name="graph_label.java7" value="pmz3170"/>
		<property name="graph_label.java70_27" value="pmz3170_27"/>
		<property name="graph_label.java8" value="pmz3180"/>
		<property name="graph_label.java9" value="pmz3190"/>
		<property name="graph_label.osid" value="zos"/>
		...
		<property name="graph_req.arch1" value="arch:31bit"/>
		...
		<property name="j2seRuntimeDir" value="jre/lib/s390"/>
		<property name="j2seTags" value="j9vmmz3124,pmz3160"/>
		...
		<property name="localRootPath" value="$(J9_ZOS_ROOT)"/>
		<property name="longLimitCmd" value=""/>
		<property name="main_shortname" value="mz31"/>
		<property name="os.lineDelimiter" value="unix"/>
		<property name="platform_arch" value="s390"/>
		...
		<property name="uma_type" value="unix,zos"/>
	</properties>
	<features>
		<feature id="combogc"/>
		<feature id="core"/>
	...
	<flags>
		...
		<flag id="jit_32bitUses64bitRegisters" value="true"/>
		...
		<flag id="port_zosCEEHDLRSupport" value="true"/>
