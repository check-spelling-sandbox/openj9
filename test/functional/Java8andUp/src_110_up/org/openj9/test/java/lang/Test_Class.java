...
*/
	...
	try {
		...
		Assert.fail("jdk.internal.reflect.Reflection.fieldFilterMap should NOT be accessible via reflection");
	} catch (NoSuchFieldException e) {
	}

	try {
		java.lang.reflect.Field f = jdk.internal.reflect.Reflection.class.getDeclaredField("methodFilterMap");
		Assert.fail("jdk.internal.reflect.Reflection.methodFilterMap should NOT be accessible via reflection");
	} catch (NoSuchFieldException e) {
	}
}
